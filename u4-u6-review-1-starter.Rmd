...
left_join(classes)
```
```{r filter-months, eval=T}
df_liane %>%
  filter(month_name == c("January", "February", "March", "April", "May", "June", "July", "August", "September", "October"))

temperature_f <- pull(df_liane)
```
